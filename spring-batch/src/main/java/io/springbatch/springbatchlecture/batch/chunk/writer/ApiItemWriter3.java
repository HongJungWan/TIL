...
public class ApiItemWriter3 extends FlatFileItemWriter<ApiRequestVO> {
    ...
    private AbstractApiService apiService; // 외부 API 호출을 위한 서비스 의존성
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        // 파일 쓰기 설정
        super.setResource(new FileSystemResource("C:\\jsw\\inflearn\\spring-batch-lecture\\src\\main\\resources\\product3.txt")); // 출력 파일 경로 설정
